...
public:
    ...
    virtual bool GetOrchardAnchorAt(const uint256 &rt, OrchardMerkleTree &tree) const = 0;
...
public:
    ...
    bool GetOrchardAnchorAt(const uint256 &rt, OrchardMerkleTree &tree) const { return false; }
